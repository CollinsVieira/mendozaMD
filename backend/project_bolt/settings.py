...
ROOT_URLCONF = 'project_bolt.urls'
...
WSGI_APPLICATION = 'project_bolt.wsgi.application'
...
if DATABASE_URL and HAS_DJ_DATABASE_URL:
    # Usar PostgreSQL con DATABASE_URL (Docker/Producción)
    DATABASES = {
...
# Temporalmente deshabilitado para usar storage local
...
# Configuración para storage local (desarrollo)
